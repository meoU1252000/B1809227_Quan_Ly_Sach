...
if(isset($_POST['last_id']) && !isset($_POST['idGroup']) && !isset($_POST['idType'])){
    $output = '';  
    $product_id = '';  
    $sql = "SELECT * FROM product WHERE id_product > ".$_POST['last_id']." LIMIT 3";  
    ...
    if(!isset($_POST['last_id'])){
      ...
      $sql = "SELECT * FROM product WHERE id_type = '$id' and id_product > ".$_POST['last_id']." LIMIT 3"; 
    }
    $result = mysqli_query($conn, $sql);  
    if(mysqli_num_rows($result) > 0)  
    {  
  ...
  if(!isset($_POST['last_id'])){
    ...
    while($row_type = mysqli_fetch_array($query_type)){
      $id_type = $row_type['id_type'];
      $sql = "SELECT * FROM product WHERE id_type = '$id_type' and id_product > ".$_POST['last_id']." LIMIT 3";  
      $result = mysqli_query($conn, $sql);  
      if(mysqli_num_rows($result) > 0)  
      {  
          while($row_book = mysqli_fetch_array($result))  
