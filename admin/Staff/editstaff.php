...
if (!isset($_SESSION['username'])) {
    ...
    if(isset($_POST['nameStaff']) || isset($_POST['addressStaff']) 
     ...
     || isset($_POST['note'])){
         ...
         $phone = $_POST['phone'];
         $note = $_POST['note'];
         $sql = "UPDATE staff SET name_staff = '$name',
                                ...
                                <div class="card-body">
                                    ...
                                    ?>
                                         <div class="form-group">
                                           ...
                                           <input type="text" class="form-control" id="nameStaff" name="nameStaff"  placeholder="Enter Name" value = "<?php echo $row['name_staff'];?>">
                                           <span class="form-group__message"></span>
                                         </div>
                                         <div class="form-group">
                                           <label for="inputAddress">Địa Chỉ Liên Hệ</label>
                                           <input type="text" class="form-control" id="addressStaff" name="addressStaff"  placeholder="Enter Address" value = "<?php echo $row['address_staff'];?>">
                                           <span class="form-group__message"></span>
                                         </div>
                                         <div class="form-group">
                                           <label for="inputPosition">Chức Vụ</label>
                                           <input type="text" class="form-control" id="positionStaff" name="positionStaff"  placeholder="Enter Position" value = "<?php echo $row['position_staff'];?>">
                                           <span class="form-group__message"></span>
                                         </div>
                                         <div class="form-group">
                                           <label for="inputEmail">Số Điện Thoại Liên Hệ</label>
                                           <input type="text" class="form-control" id="phone" name="phone"  placeholder="Enter Phone" value = "<?php echo $row['phone_staff'];?>">
                                           <span class="form-group__message"></span>
                                         </div>
                                         <div class="form-group">
                                           <label for="InputNote">Ghi Chú</label>
                                           <input type="text" class="form-control" id="note" name="note" placeholder="Enter Note" value = "<?php echo $row['note_staff'];?>">
                                           <span class="form-group__message"></span>
                                         </div>
                                        <?php } ?>
