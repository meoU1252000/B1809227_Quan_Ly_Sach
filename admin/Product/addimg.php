...
if (!isset($_SESSION['username'])) {
    ...
    if(isset($_POST['add-img'])){
        ...
        move_uploaded_file($_FILES['product-img']['tmp_name'],$product_img);
         $sql = "INSERT into productimage(id_product,link_img) values ('$id_product','$product_img')";
         if(mysqli_query($conn,$sql)){
             $_SESSION['status'] = "Thêm Hình Ảnh Thành Công!";
            ...
            $_SESSION['status'] = "Thêm Hình Ảnh Thất Bại!";
                    ...
                    <div class="card mb-4">
                                ...
                                <div class="card-body">
                                         <div class="form-group">
                                            <label for="InputTypeGroup">Chọn Sản Phẩm Muốn Thêm Ảnh</label>   
                                        ...
                                        <a href = "index.php?page_layout=productImg" class="btn btn-primary " style="margin-top:12px"><i class="fas fa-arrow-left" style="margin-right:6px"></i>Back</a>
